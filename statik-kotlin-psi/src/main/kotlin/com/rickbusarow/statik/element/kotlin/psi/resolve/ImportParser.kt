...
@InternalStatikApi
public class ImportParser(private val importDirectives: List<KtImportDirective>) {

  private val _aliasMap = mutableMapOf<String, ReferenceName>()

  public val aliasMap: Map<String, ReferenceName> by unsafeLazy {
    imports
    _aliasMap
  }

  public val imports: Set<ReferenceName> by lazy {
  ...
  public val wildcards: Set<String> by lazy {
