...
@InternalStatikApi
internal fun KtDeclaration.isInObject(): Boolean = containingClassOrObject?.isObjectLiteral() ?: false
...
@InternalStatikApi
internal fun KtDeclaration.isInObjectOrCompanionObject(): Boolean = isInObject() || isInCompanionObject()

/** @return true if the receiver declaration is a companion object */
@OptIn(ExperimentalContracts::class)
@InternalStatikApi
internal fun KtDeclaration.isCompanionObject(): Boolean {
  contract {
