 ...
 */
@InternalStatikApi
internal inline fun <reified T : PsiElement> PsiElement.childrenOfTypeDepthFirst(): Sequence<T> {
  return Traversals.depthFirstTraversal(this) { children.toList() }
    .filterIsInstance<T>()
}
 ...
 */
@InternalStatikApi
internal inline fun <reified T : PsiElement> PsiElement.childrenOfTypeBreadthFirst(): Sequence<T> {
...
@InternalStatikApi
internal fun KotlinType?.requireReferenceName(): ReferenceName {
...
@InternalStatikApi
internal fun PsiElement.isQualifiedPropertyOrCallExpression(): Boolean {
 ...
 */
@InternalStatikApi
internal fun PsiElement.callSiteName(): String {
