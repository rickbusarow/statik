...
@InternalStatikApi
internal fun KtCallableDeclaration.isJvmStatic(): Boolean {
  return hasAnnotation(FqNames.jvmStatic)
}

@InternalStatikApi
internal fun KtProperty.isJvmField(): Boolean {
  return hasAnnotation(FqNames.jvmField)
}

@InternalStatikApi
internal fun KtFunction.jvmNameOrNull(): String? = annotatedJvmNameOrNull()

@InternalStatikApi
internal fun KtPropertyAccessor.jvmNameOrNull(): String? = annotatedJvmNameOrNull()
