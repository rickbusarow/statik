...
import com.rickbusarow.statik.McFile.McJavaFile
import com.rickbusarow.statik.McFile.McKtFile
import com.rickbusarow.statik.element.McFunction
import com.rickbusarow.statik.element.McProperty
...
sealed interface McKtDeclaredElement :
  McKtElement,
  Declared

/** Represents an element with a parent element. */
sealed interface McElementWithParent<E : McElement> :
  McElement {
  /** The parent element */
  val parent: E
}
...
interface McAnnotationArgument :
  McElement,
  McElementWithParent<McElement> {
