...
package com.rickbusarow.statik.element.impl.kotlin
...
import com.rickbusarow.statik.compiler.impl.KotlinEnvironmentImpl
import com.rickbusarow.statik.compiler.impl.StatikMessageCollector
import com.rickbusarow.statik.compiler.inerceptor.ParsingChain
import com.rickbusarow.statik.compiler.inerceptor.impl.ImportAliasUnwrappingParsingInterceptor
import com.rickbusarow.statik.compiler.kotlinStdLibNameOrNull
...
import com.rickbusarow.statik.testing.HostEnvironment
...
class PsiTestEnvironment(
  ...
  internal val kotlinEnvironmentDeferred: LazyDeferred<KotlinEnvironmentImpl> = lazyDeferred {
    KotlinEnvironmentImpl(
      ...
      kotlinLanguageVersion = LanguageVersion.KOTLIN_1_8,
  ...
  suspend fun createKotlin(@Language("kotlin") content: String): StatikKotlinFile {
    ...
    val context = StatikElementContext<PsiElement>(
