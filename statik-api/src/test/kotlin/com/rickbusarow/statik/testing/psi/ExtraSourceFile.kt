...
/**
 * Models some source code with a relative path. The two properties may be combined with
 * a parent working directory in order to create source code for a test's compilation.
 *
 ...
 */
fun ExtraSourceFile.Companion.from(
